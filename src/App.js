...
function App() {
  ...
  const productCatalog = [
    {
      image: "./media/lo_schermo_del_master.jpg",
    ...
    {
      image: "./media/game_changers.jpg",
      name: "Game-changers: il gioco di ruolo",
      position: "Third Slide",
      price: "40€",
      description: "Strumento, metodo e sistema di gioco...",
      description2: "Strumento, metodo e sistema di gioco. È composto da carte illustrate da un maestro di belle arti, avventure scritte da un’equipe di designer e scrittori di Tou.Play e da un sistema di regole che lo rende adatto ad ogni contesto, da quello educativo a quello pubblico di fiere e manifestazioni ludiche ma anche per epiche campagne da giocare con i tuoi amici e le tue amiche!",
    },

    {
      image: "./media/virruzzo.jpg",
      name: "Virruzzo",
    ...
    {
      image: "./media/il_trono_di_puglia.jpg",
